...
from babuUtils import Generate_Response
...
# Define messages for OpenAI interaction
gpt_msg = [
...
##            sys.stdout.flush()
            ...
            print(f'calling function on [{final_transcript}]')
            gpt_msg = Generate_Response(final_transcript,gpt_msg)
